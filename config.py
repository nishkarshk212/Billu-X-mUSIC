...
class Config:
    def __init__(self):
        ...
        self.STORAGE_GROUP_ID = int(getenv("STORAGE_GROUP_ID", 0))
        self.OWNER_ID = int(getenv("OWNER_ID", 6164092524))
        ...
        self.RAILWAY_YT_API_URL = getenv("LILY_API_URL", getenv("RAILWAY_YT_API_URL", "https://publicapi-588300c22203.herokuapp.com"))
